...
func (s *TestStorage) GetClient(id string) (server.Client, error) {
...
func (s *TestStorage) SaveAuthorize(data *server.AuthorizeData) error {
	fmt.Printf("SaveAuthorize: %s\n", data.Code)
	s.authorize[data.Code] = data
	return nil
}

func (s *TestStorage) LoadAuthorize(code string) (*server.AuthorizeData, error) {
...
func (s *TestStorage) SaveAccess(data *server.AccessData) error {
...
func (s *TestStorage) LoadAccess(code string) (*server.AccessData, error) {
...
func (s *TestStorage) LoadRefresh(code string) (*server.AccessData, error) {
